	...
	var Mapplic = function() {
		...
		self.init = function(el, params) {
			...
			if (typeof self.o.source === 'string') {
				...
				$.getJSON(self.o.source, function(data) { // Success
					...
					console.error('removed browser alert : Data file missing or invalid!');
				});
			}
			else {
				// Inline json object
		...
		function Tooltip() {
			...
			this.init = function() {
				...
				this.link = $('<a>Consulter la fiche</a>').addClass('mapplic-tooltip-link').attr('href', '#').attr('target', '_top').hide().appendTo(this.el);
