...
var SCENE={
    set:function(data){
    	...
    	for(var i=0;i<data.meshes.length;i++){
    	    if(data.meshes[i].userData.steps[0]==true&&i>7/*so cars are not added yet*/)scene.add(data.meshes[i]);
    	    if(i>7&&i<11||i>19)data.meshes[i].castShadow=data.meshes[i].receiveShadow=true;
